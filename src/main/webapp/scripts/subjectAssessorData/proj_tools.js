                    ...
                    if (this.selector.config.uri == undefined) {
                        ...
                        xmodal.confirm({
                            ...
                            content: "<p>Modifying the " + this.selector.config.header + " of an imaging " + 
                                     ...
                                     XNAT.app.displayNames.singular.project.toLowerCase() + 
                                     "'s storage space. If a project level anonymization script is configured, it will result in the re-execution of project level anonymization (though reject statements will be ignored). Are you sure you want to make this change?</p>",
                            okAction: function(){
                                if(showReason){
