...
@AutoValue
public abstract class EventFilterUpdate {
    ...
    @JsonCreator
    public static EventFilterUpdate create(
            @Nullable @JsonProperty("name")                 String name,
            @Nullable @JsonProperty("event-type")           String eventType,
    ...
    public static Builder builder() {return new AutoValue_EventFilterUpdate.Builder();}
    ...
    public abstract static class Builder {
        ...
        public abstract EventFilterUpdate build();
    }
}
