...
public abstract class SubscriptionUpdate {
    ...
    @Nullable @JsonProperty("event-filter") public abstract EventFilterUpdate eventFilter();
    ...
    @JsonCreator
    public static SubscriptionUpdate create(@Nullable  @JsonProperty("name") final String name,
                                             ...
                                             @JsonProperty("event-filter") final EventFilterUpdate eventFilter,
    ...
    public static Builder builder() {return new AutoValue_SubscriptionUpdate.Builder();}
    ...
    public abstract static class Builder {
        ...
        public abstract Builder eventFilter(EventFilterUpdate eventFilter);

        public abstract Builder actAsEventUser(Boolean actAsEventUser);

        public abstract SubscriptionUpdate build();
    }
