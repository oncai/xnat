...
public final class DicomInboxImporter extends ImporterHandlerA implements FileVisitor<Path> {
    ...
    private static final Logger _log = LoggerFactory.getLogger(DicomInboxImporter.class);
